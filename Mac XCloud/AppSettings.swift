    ...
    static let all: [SettingsCategory] = [
        ...
        SettingsCategory(id: "mkb", title: "Mouse & Keyboard", icon: "keyboard", rows: [
            SettingDef(id: "mkb.enabled", label: "Emulate controller with Mouse & Keyboard",
                       note: "Play games that don't support MKB by faking a controller. Could be viewed as cheating online. Activate in-game with F8 or the Settings menu (⇧⌘K); the HUD shows KBM when active.",
                       scope: .global, kind: .toggle(defaultValue: false)),
            SettingDef(id: "nativeMkb.mode", label: "Native Mouse & Keyboard",
                       note: "Uses the real MKB support some games offer, with no emulation. Only games advertising MKB support respond to it.",
                       scope: .global, kind: .option(
            ...
            SettingDef(id: "mkb.profiles", label: "Virtual controller profiles",
                       note: "Create and edit your own MKB button layouts. The built-in Standard layout is assigned automatically.",
            ...
            SettingDef(id: "userAgent.profile", label: "User-Agent profile",
                       note: "Some Xbox site features (like the keyboard & mouse icons on game cards) only appear for browsers the site recognizes. \"Edge + Windows\" enables them; reload the page to apply.",
                       scope: .global, kind: .option(
                            values: ["default", "windows-edge", "macos-safari"],
                            labels: ["Default (this Mac)", "Edge + Windows", "Safari + macOS"],
                            defaultValue: "default")),
        ]),
